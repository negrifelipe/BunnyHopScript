...
This program was made for me to know a little bit more of game hacking and please if you are going to use it, use it on ofline mode or for private matchs using the -insecure parameter in csgo
